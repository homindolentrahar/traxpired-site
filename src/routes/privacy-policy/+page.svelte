<script>
  import { Accordion, AccordionItem, Tabs, TabItem } from "flowbite-svelte";
</script>
...
<div class="flex flex-col justify-center items-center">
  ...
  <Accordion class="w-full my-8">
    <AccordionItem>
      <span slot="header" class="text">Privacy Policy</span>
      <p>
        Yolkkreate built the Traxpired app as a Free app. This SERVICE is
        provided by Yolkkreate at no cost and is intended for use as is. This
        ...
        Conditions, which are accessible at Traxpired unless otherwise defined
        in this Privacy Policy.
      </p>
    </AccordionItem>
    <AccordionItem>
      <span slot="header" class="text">Terms & Conditions</span>
      <p>
        ...
        Yolkkreate. Yolkkreate is committed to ensuring that the app is as
        ...
        without making it very clear to you exactly what you’re paying for.<br
        />The Traxpired app stores and processes personal data that you have
        ...
        features and it could mean that the Traxpired app won’t work properly or
        at all. You should be aware that there are certain things that
        Yolkkreate will not take responsibility for. Certain functions of the
        ...
        Yolkkreate cannot take responsibility for the app not working at full
        functionality if you don’t have access to Wi-Fi, and you don’t have any
        of your data allowance left.<br />If you’re using the app outside of an
        area with Wi-Fi, you should remember that the terms of the agreement
        ...
        of the connection while accessing the app, or other third-party charges.
        ...
        Along the same lines, Yolkkreate cannot always take responsibility for the
        ...
        Yolkkreate cannot accept responsibility.<br />
        With respect to Yolkkreate’s responsibility for your use of the app, when
        ...
        you. Yolkkreate accepts no liability for any loss, direct or indirect, you
        ...
        need to download the updates if you want to keep using the app. Yolkkreate
    ...
    <AccordionItem>
      <span slot="header" class="text">Information Collection and Use</span>
      <p>
    ...
    <AccordionItem>
      <span slot="header" class="text">Log Data</span>
      <p>
    ...
    <AccordionItem>
      <span slot="header" class="text">Cookies</span>
      <p>
    ...
    <AccordionItem>
      <span slot="header" class="text">Service Providers</span>
      <p>
    ...
    <AccordionItem>
      <span slot="header" class="text">Security</span>
      <p>
    ...
    <AccordionItem>
      <span slot="header" class="text">Children’s Privacy</span>
      <p>
        ...
        processing of your personally identifiable information in your country
        (in some countries we may allow your parent or guardian to do so on your
        behalf).
      </p>
    </AccordionItem>
    <AccordionItem>
      <span slot="header" class="text">Changes to This Privacy Policy</span>
      <p>
        ...
        is effective as of 2023-05-01
      </p>
    </AccordionItem>
    <AccordionItem>
      <span slot="header" class="text"
        >Changes to This Terms and Conditions</span
      >
      <p>
    ...
    <AccordionItem>
      <span slot="header" class="text">Contact Us</span>
      <p>
        I may update our Privacy Policy from time to time. Thus, you are advised
        to review this page periodically for any changes. I will notify you of
        any changes by posting the new Privacy Policy on this page. This policy
